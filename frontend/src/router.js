...
import RiderIncome from './views/RiderIncome.vue'
...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/me/addresses', component: AddressesView, meta: { role: 'USER' } },
    ...
    { path: '/rider/income', component: RiderIncome, meta: { role: 'RIDER' } },
